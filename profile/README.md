...
- **Frontend (Web & Android):** React + Vite + TypeScript  
- **Mobile Runtime:** Capacitor (Android, iOS planned)  
- **Backend:** Node.js + Express (Dua API)  
- **Deployment:** Vercel (Web), TBD for Mobile/API

---

## 🎯 Goals

- 📖 Provide a clean, minimal Qur’an reading and Dua experience  
- 🤲 Ensure authenticity with verified Duas and references  
- 📱 Use a single codebase for web and mobile apps  
...
I'm a college student building this solo for now, so contributions are very welcome!  
Please check out the individual repo READMEs for setup instructions and contribution guidelines.

---

## 📬 Contact

Feel free to reach out if you're interested in contributing or collaborating!

- GitHub: [@EasyCanadianGamer](https://github.com/EasyCanadianGamer)  
- Email: [easygamer2019@gmail.com](mailto:easygamer2019@gmail.com)
...
*May this effort be of benefit. Insha’Allah.*
